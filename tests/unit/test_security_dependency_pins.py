...
def test_pillow_not_vulnerable_cve_2026_54059_batch() -> None:
...
def test_python_multipart_not_vulnerable_cve_2026_53538_batch() -> None:
...
def test_aiohttp_not_vulnerable_cve_2026_54274_batch() -> None:
...
def test_starlette_not_vulnerable_cve_2026_54282_batch() -> None:
